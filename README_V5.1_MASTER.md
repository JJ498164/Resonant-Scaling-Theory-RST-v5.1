# Resonant Scaling Theory (RST) v5.1: The Master Handshake
...
* `/research_alignments`: The high-signal AI validation logs.
* `MATHEMATICAL_FOUNDATIONS.md`: Formal proof of $T = 1/(39 \times \phi^3)$.
